...
A solution can be expressed in different ways and, by walking down the path toward a resolution, the human mind is gifted with the opportunity to express itself from different angles, increasing its freedom and its potential. But for that, the mind must be sharpened enough to perceive and make the choices that sustain these faculties.

The medium on which the solution is to be expressed is above all a choice, it could be a simple sheet of paper or a pipe organ, but it is in one's mind that it first takes birth.

Hardware is a substrate of possibilities and unknowns, and whoever tames hardware or any physical medium masters the information that transits through it, whether mechanical, electrical, optical, or digital. This is, and we must say it, a form of power. A power that allows humans to extend beyond the physical boundaries of their own envelope.

Under a certain angle, this path is a form of spirituality, a garden in which one's mind can be re-engineered.

*m-cid (My Custom IDentity)*
